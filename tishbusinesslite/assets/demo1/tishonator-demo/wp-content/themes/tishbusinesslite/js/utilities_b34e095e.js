...
function replacePremiumBlocksMessage() {
  const premiumBlocks = [
    '.wp-block-tishonator-projects-block',
    '.wp-block-tishonator-testimonials-block',
    '.wp-block-tishonator-team-members-block',
    '.wp-block-tishonator-recent-posts-columns',
    '.wp-block-tishonator-clients-block'
  ];

  const message = 'This Block is available in Premium Theme Version ONLY';

  premiumBlocks.forEach(selector => {
...
document.addEventListener('DOMContentLoaded', replacePremiumBlocksMessage);
