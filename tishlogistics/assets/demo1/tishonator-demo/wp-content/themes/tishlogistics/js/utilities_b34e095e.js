...
//t assets/js/moving-animation.js
...
(function ($) {
    ...
    /*------------------------------------------
       = TEAM SECTION
   -------------------------------------------*/
    var singleMember = jQuery('.social');
  ...
  -------------------------------------------*/
    ...
    /*------------------------------------------
        = project SLIDER
    -------------------------------------------*/
    if (jQuery(".wpo-project-slider").length) {
        jQuery(".wpo-project-slider").owlCarousel({
            autoplay: false,
            smartSpeed: 300,
            margin: 20,
            loop: true,
    ...
    /*------------------------------------------
        = project SLIDER
    -------------------------------------------*/
    if (jQuery(".wpo-project-slider-s2").length) {
        jQuery(".wpo-project-slider-s2").owlCarousel({
            autoplay: false,
            smartSpeed: 300,
            margin: 100,
            loop: true,
    ...
    /*------------------------------------------
        = Testimonial SLIDER
    -------------------------------------------*/
    if (jQuery(".wpo-testimonial-wrap").length) {
        jQuery(".wpo-testimonial-wrap").owlCarousel({
            autoplay: false,
            smartSpeed: 300,
            margin: 30,
            loop: true,
    ...
    /*------------------------------------------
        testimonial-active
        -------------------------------------------*/
    if (jQuery(".testimonial-active").length) {
    ...
    /*------------------------------------------
          blog-slide-active
        -------------------------------------------*/
    if (jQuery(".blog-slide-active").length) {
        jQuery(".blog-slide-active").owlCarousel({
            autoplay: false,
            smartSpeed: 300,
            margin: 30,
            loop: true,
    ...
    /*------------------------------------------
        service-active
        -------------------------------------------*/
    if (jQuery(".service-active").length) {
        jQuery(".service-active").owlCarousel({
            autoplay: false,
            smartSpeed: 300,
            margin: 30,
            loop: true,
    ...
    if (jQuery("#contact-form-main").length) {
        jQuery("#contact-form-main").validate({
            ...
            messages: {
                ...
                deliverCity: "Please enter Deliver City",
                departureCity: "Please enter Departure City",
                freightType: "Please Select Freight Type",
                incoterms: "Please select Incoterms",
                weight: "Please enter Weight",
                express: "Please select Express",
            },
