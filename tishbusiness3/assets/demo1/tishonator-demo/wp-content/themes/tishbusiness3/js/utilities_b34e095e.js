...
jQuery( document ).ready(function() {
  ...
  jQuery('#main-menu__main-menu-box > div > ul').unwrap();

  jQuery('#main-menu__main-menu-box > ul').addClass('main-menu__list');

  jQuery('#main-menu__main-menu-box li').each(function(){
  ...
  if (jQuery(".mobile-nav__container .main-menu__list").length) {
  ...
  jQuery('.content a.more-link').addClass('thm-btn main-menu__btn');
});
