...
(function($) {
  ...
  $(".faq__two-collapse-item-card-header").on('click', function() {
  ...
  $(".faq__two-collapse-item-card-header-two").on('click', function() {
