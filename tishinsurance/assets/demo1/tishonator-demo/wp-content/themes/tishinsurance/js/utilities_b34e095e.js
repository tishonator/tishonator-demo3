...
jQuery( document ).ready(function() {
  jQuery('#hdr-main-menu-cntr > div > ul').unwrap();

  jQuery('#hdr-main-menu-cntr > ul').addClass('main-menu__list');

  jQuery('#hdr-main-menu-cntr > ul > li').each(function(){
  ...
  if (jQuery(".main-menu__list").length && jQuery(".mobile-nav__container").length) {
    jQuery(".main-menu__list").clone().removeClass('main-menu__list').addClass('mobile-menu__list').appendTo('.mobile-nav__container');
  }

  if (jQuery(".sticky-header").length) {
    jQuery(".sticky-header").clone().insertAfter('.sticky-header').addClass('sticky-header--cloned');
  }
  ...
  if (jQuery(".side-drawer__toggler").length) {
    jQuery(".side-drawer__toggler").on("click", function (e) {
      e.preventDefault();
      jQuery(".side-drawer__wrapper").toggleClass("expanded");
      jQuery("body").toggleClass("locked");
    });
  }
  ...
  jQuery('a.more-link').addClass('thm-btn thm-btn--two blog-card__btn');
  jQuery('a.more-link').append('<i class="fa fa-arrow-right"></i>');
...
//t assets/vendors/owl-carousel/dist/owl.carousel.min.js
/**
 * Owl Carousel v2.3.4
...
//t assets/vendors/youtube-popup/youtube-popup.jquery.js
/*
    Name: YouTubePopUp
...
/*t
	if ($(".main-menu__list").length && $(".mobile-nav__container").length) {alert('AAA1');
