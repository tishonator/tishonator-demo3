...
(function($){
  ...
  $('#vs-mobile-menu > div > ul').unwrap();

  $('#vs-mobile-menu li').each(function(){
  ...
  $('.more-link').addClass('link-btn').append('<i class="fa fa-long-arrow-right"></i>');
