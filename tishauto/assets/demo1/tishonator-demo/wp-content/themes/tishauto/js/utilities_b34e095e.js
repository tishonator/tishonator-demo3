...
jQuery( document ).ready(function() {
  ...
  jQuery('#navbarSupportedContent > ul').addClass('navbar-nav mr-0');
  jQuery('#navbarSupportedContent li').addClass('nav-item');

  jQuery('#navbarSupportedContent > ul > li > a')
    .addClass('nav-link text-decoration-none navbar-text-color home-margin-top');

  jQuery('#navbarSupportedContent > ul > li > a').each(function(){
    if (jQuery(this).attr('aria-current')) {
      jQuery(this).parent().addClass('active');
    }
  });

  jQuery('#navbarSupportedContent ul ul').wrap('<div class="dropdown-menu autorix-drop-down"></div');
  jQuery('#navbarSupportedContent ul ul').addClass('list-unstyled');
  jQuery('#navbarSupportedContent ul ul a').addClass('dropdown-item nav-link');

  jQuery('#navbarSupportedContent > ul > li').each(function(){
    if (jQuery(this).find('> div.dropdown-menu').length > 0) {
        jQuery(this).addClass('dropdown sancare-li-color show');
        jQuery(this).find('> a').addClass('nav-link dropdown-toggle').attr('role', 'button')
          .attr('data-toggle', 'dropdown').attr('aria-haspopup', 'true')
          .attr('aria-expanded', 'true');
    }
  });

  jQuery('nav.navbar').css('display', 'flex');

  if (jQuery(window).width() < 992 && jQuery('.navbar-toggler').length) {
    jQuery('#navbarSupportedContent').css('top', (jQuery('.navbar-toggler').offset().top) + 'px'); 
  }
...
/*t
jQuery(document).ready(function () {
  //t jQuery('#navbarSupportedContent').
  jQuery('.navbar ul > li > a').on('hover', function(){
...
jQuery(document).ready(function () {
  ...
  jQuery('.about-us-section .counter').each(function () {
  ...
  jQuery(document).ready(function () {
      ...
      jQuery('.about-us-section-page .counter').each(function () {
          jQuery(this).prop('Counter', 0).animate({
              Counter: jQuery(this).text()
          }, {
              duration: 4000,
  ...
  jQuery(document).ready(function () {
      ...
      jQuery('.box-section .counter').each(function () {
          jQuery(this).prop('Counter', 0).animate({
              Counter: jQuery(this).text()
          }, {
              duration: 4000,
...
//t assets/js/text-animations.js
/*t
AOS.init({
    duration: 1000,
    offset: 120,
...
//t assets/js/carousel.js
jQuery(document).ready(function () {
    var owl = jQuery('.our-work-section .owl-carousel');
    owl.owlCarousel({
        margin: 30,
        nav: true,
        loop: true,
...
jQuery(document).ready(function () {
    var owl = jQuery('.carousel-section .owl-carousel');
    owl.owlCarousel({
        margin: 30,
        nav: true,
        loop: true,
...
//t assets/js/showhide.js
jQuery('.teams-section .Show1').on('click', function() {
    jQuery('.teams-section #target1').show(200);
    jQuery('.teams-section .Show1').hide(0);
    jQuery('.teams-section .Hide1').show(0);
});
jQuery('.teams-section .Hide1').on('click', function() {
    jQuery('.teams-section #target1').hide(500);
    jQuery('.teams-section .Show1').show(0);
    jQuery('.teams-section .Hide1').hide(0);
});

jQuery('.teams-section .Show2').on('click', function() {
    jQuery('.teams-section #target2').show(200);
    jQuery('.teams-section .Show2').hide(0);
    jQuery('.teams-section .Hide2').show(0);
});
jQuery('.teams-section .Hide2').on('click', function() {
    jQuery('.teams-section #target2').hide(500);
    jQuery('.teams-section .Show2').show(0);
    jQuery('.teams-section .Hide2').hide(0);
});

jQuery('.teams-section .Show3').on('click', function() {
    jQuery('.teams-section #target3').show(200);
    jQuery('.teams-section .Show3').hide(0);
    jQuery('.teams-section .Hide3').show(0);
});
jQuery('.teams-section .Hide3').on('click', function() {
    jQuery('.teams-section #target3').hide(500);
    jQuery('.teams-section .Show3').show(0);
    jQuery('.teams-section .Hide3').hide(0);
});


jQuery('.teams-section .Show4').on('click', function() {
    jQuery('.teams-section #target4').show(200);
    jQuery('.teams-section .Show4').hide(0);
    jQuery('.teams-section .Hide4').show(0);
});
jQuery('.teams-section .Hide4').on('click', function() {
    jQuery('.teams-section #target4').hide(500);
    jQuery('.teams-section .Show4').show(0);
    jQuery('.teams-section .Hide4').hide(0);
});


jQuery('.teams-section .Show5').on('click', function() {
    jQuery('.teams-section #target5').show(200);
    jQuery('.teams-section .Show5').hide(0);
    jQuery('.teams-section .Hide5').show(0);
});
jQuery('.teams-section .Hide5').on('click', function() {
    jQuery('.teams-section #target5').hide(500);
    jQuery('.teams-section .Show5').show(0);
    jQuery('.teams-section .Hide5').hide(0);
});



jQuery('.teams-section .Show6').on('click', function() {
    jQuery('.teams-section #target6').show(200);
    jQuery('.teams-section .Show6').hide(0);
    jQuery('.teams-section .Hide6').show(0);
});
jQuery('.teams-section .Hide6').on('click', function() {
    jQuery('.teams-section #target6').hide(500);
    jQuery('.teams-section .Show6').show(0);
    jQuery('.teams-section .Hide6').hide(0);
});
...
jQuery('.our-teams-page .Show16').on('click', function() {
    jQuery('.our-teams-page #target16').show(200);
    jQuery('.our-teams-page .Show16').hide(0);
    jQuery('.our-teams-page .Hide16').show(0);
});
jQuery('.our-teams-page .Hide16').on('click', function() {
    jQuery('.our-teams-page #target16').hide(500);
    jQuery('.our-teams-page .Show16').show(0);
    jQuery('.our-teams-page .Hide16').hide(0);
});

//t https://cdnjs.cloudflare.com/ajax/libs/magnific-popup.js/1.1.0/jquery.magnific-popup.js
...
jQuery( document ).ready(function() {
  ...
  jQuery('.carosel-img img').removeClass('wp-post-image');

  jQuery('.entry-title, nav-link contact').addClass("animations-hidden").viewportChecker({
      repeat: true,
      classToAdd: 'animated zoom-in',
      offset: 1    
    });
  ...
  jQuery('.wp-post-image').addClass("animations-hidden").viewportChecker({
      repeat: true,
